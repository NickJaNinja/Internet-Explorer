...
class Player {
     ...
     */
    func Player(name: String, pilotSkill: Int, fighterSkill: Int, traderSkill: Int, engineerSkill: Int, credits: Int, ship: Ship) {
        self.name = name;
     ...
     * @param engineerSkill inital engineerSkill
     */
    func Player(name: String, pilotSkill: Int, fighterSkill: Int, traderSkill: Int, engineerSkill: Int) {
